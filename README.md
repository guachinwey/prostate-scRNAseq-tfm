...
Incluye las figuras, tablas y salidas finales del análisis, organizadas por bloques temáticos (control de calidad, clustering, genes característicos, anotación poblacional, estudio poblacional y DEGs).
